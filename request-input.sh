...
cat "MANJARO_DOTFILES_GITCONFIG_NAME=$MANJARO_DOTFILES_GITCONFIG_NAME" >> $tmpConfigFile
cat "MANJARO_DOTFILES_GITCONFIG_EMAIL=$MANJARO_DOTFILES_GITCONFIG_EMAIL" >> $tmpConfigFile
######################### Git Config ##########################
